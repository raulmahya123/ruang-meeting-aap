      ...
      <div class="p-4 sm:p-6 grid grid-cols-1 sm:grid-cols-2 gap-4 sm:gap-6">
        ...
        <div>
          ...
          <p class="text-[11px] text-gray-500 mt-1">
            Pilih tanggal, <strong>jam</strong>, dan <strong>menit</strong> (format 24-jam). Contoh <span class="font-mono">14:30</span>.
          </p>
          @error('start_at') <p class="text-xs text-red-700 mt-1">{{ $message }}</p> @enderror
        </div>

        {{-- Selesai: tanggal + (Jam, Menit) --}}
        <div>
          ...
          <p class="text-[11px] text-gray-500 mt-1">
            Jika tidak diisi, waktu selesai otomatis **+60 menit** dari waktu mulai.
          </p>
...
<script>
  ...
  function getDT(prefix){
    ...
    // Build Date di waktu lokal browser
